...
class SemiLepBDecayTagger(Module):
    ...
    def beginFile(self, inputFile, outputFile, inputTree, wrappedOutputTree):
        ...
        self.out.branch("ToMaAn_invMass_softMu_hardMu", "F")
        ...
        self.histos[ 'invMass_softMu_hardMu' ] = ROOT.TH1F( 'invMass_softMu_hardMu', ';M_{#mu_{soft},#mu_{hard}}; Events',500,0.,250.)
    ...
    def analyze(self, event):
        ...
        self.out.fillBranch( 'ToMaAn_invMass_softMu_hardMu' , -100. )
	...
	p4_bs = []
        ...
        if len(good_soft_muons) > 0:
            ...
            self.histos[ 'invMass_softMu_hardMu' ].Fill( observable_4vec.M() )
            self.out.fillBranch("ToMaAn_invMass_softMu_hardMu", observable_4vec.M())
